            ...
            {userTrades.length === 0 ? (
                ...
                <div className={styles.tradesList}>
                    {userTrades.map((trade) => {
                        const isUser1 = trade.user1._id === currentUser.id;
                        const yourItems = isUser1 ? trade.items1 : trade.items2;
                        const theirItems = isUser1 ? trade.items2 : trade.items1;
                        const otherUser = isUser1 ? trade.user2.username : trade.user1.username;
