...
import { createItem, deleteItem, updateItem, getProducts, searchProducts, getAllproducts, changeOwner } from "../controllers/items.js";
...
router.route("/:id/changeOwner").patch(changeOwner);
